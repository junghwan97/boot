...
public class Controller18 {
	...
	// transaction 설정 없이 중간에 exception 발생
	...
	// transaction 설정 후 모두 실패 (중간에 exception 발생시)
	...
	public void method4() throws Exception {
		...
		try (con; Statement stmt1 = con.createStatement(); Statement stmt2 = con.createStatement();) {
			con.setAutoCommit(false);
			stmt1.executeUpdate(sql1);
